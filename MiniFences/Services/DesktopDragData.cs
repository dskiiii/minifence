...
internal static class DesktopDragData
{
            ...
            Type = string.IsNullOrWhiteSpace(target)
                ...
                : effect == System.Windows.DragDropEffects.Move
                    ...
                    : effect == System.Windows.DragDropEffects.Copy
                        ? DropImageType.Copy
                        : DropImageType.Link,
            Message = BuildDropDescriptionMessage(target, chinese), /* obsolete corrupted template
                ? string.Empty
    ...
    private static string BuildDropDescriptionMessage(string? target, bool chinese) =>
